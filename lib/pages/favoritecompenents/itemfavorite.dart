...
class ItemFavorite extends StatefulWidget {
  final int index;
  final FavoritProduct productfavorite;
...
class _ItemFavoriteState extends State<ItemFavorite> {
  ...
  void intval() async {
    ...
    //     .isfavorite(widget.productfavorite.productId!);
    if (widget.categoriesname == "hh")
    {
      Category g = Category();
      g = await Apiserver.getCategorysbyid(widget.productfavorite.product!.categoryId!);
      setState(() {
  ...
  void _remove() async {
    Provider.of<FavoriteModel>(context, listen: false)
            .removefromfavorite(widget.productfavorite,);
  }
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              width: 100,
                              child: Text(
                                widget.productfavorite.product!.name.toString(),
                                style: TextStyle(
                      ...
                      InkWell(
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) => Detailes(
                                      ...
                                      product: widget.productfavorite.product!,
                                    )),
                          ).then((result) {
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: NetworkImage(
                                'http://localhost:3000/${widget.productfavorite.product!.image!}'),
                          )),
                        ),
                      ),
                      Container(
                        ...
                        child: Padding(
                          ...
                          child: Row(
                              ...
                              children: [
                                Text(
                                  '\$${widget.productfavorite.product!.price}',
                                  style: TextStyle(
                                      color: Colors.orange,
